...
def init_cmd(skills_dir: str | None, formats: str | None, yes: bool) -> None:
    ...
    if skills_dir is None:
        # Try to auto-detect: walk up looking for a skills/ dir
        detected = _detect_skills_dir()
        default = str(detected) if detected else "~/universal-skills/skills"
        if yes:
            skills_dir = default
        else:
...
def sync_cmd(project: str | None, sync_global: bool) -> None:
